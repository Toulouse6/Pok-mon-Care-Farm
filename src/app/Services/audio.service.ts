...
export class AudioService {
    ...
    // background Music
    private backgroundAudio = new Audio('/src/assets/audio/retro-game1.mp3');
    ...
    playSoundEffect(soundFile: string): void {
        const soundEffect = new Audio(`/src/assets/audio/${soundFile}`);
        soundEffect.onerror = () => {
    ...
    taskCompleteEffect(file: string): void {
        const effect = new Audio(`/src/assets/audio/${file}`);
